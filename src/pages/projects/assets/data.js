...
import { SigNozIcon, AngelOneIcon, MoneyHopIcon } from "./icons";
...
export const projects = [
  {
    ...
    description: (
      <>
        ...
        <p>
          Signoz's frontend tech stack is built on React and Redux, providing a
          robust and scalable architecture for the user interface of the
          application. Additionally, it incorporates Ant Design components for a
    ...
    links: [
      <ExternalLink to="https://github.com/SigNoz/signoz">GitHub</ExternalLink>,
    ],
  },
  {
    title: (
    ...
    description: (
      <>
        <p>
          ...
          allows users to trade in equities, derivatives, and mutual funds. With
          its user-friendly interface and comprehensive research tools, AngelOne
          aims to provide a seamless and efficient trading experience for
        ...
        <div>
          ...
          <ul>
            <li>
              Created an eSign KYC module for sub-brokers to facilitate trading
              with AngelOne. Implemented custom validation of buttons at every
              step of KYC to prevent unwanted actions by end users.
            </li>
            <li>
              Configured Unit testing and E2E testing libraries like Jest and
              Cypress.io from scratch. Wrote over 534 test cases for components,
              pages, and E2E services to achieve the desired code coverage.
            </li>
            <li>
    ...
    links: [
      <ExternalLink to="https://trade.angelone.in/">AngelOne KYC</ExternalLink>,
    ],
  },
  {
    title: (
    ...
    description: (
      <>
        <p>
          moneyHOP is We are a full-stack banking solution that lets users Save,
          Invest, Borrow, and Spend. It has introduced the concept of ‘One
          Global Account - One Global Card’ - which allows users to do
